  ...
  <div class="hero-container">
    <div class="hero-inner container clearfix">
      <div class="hero-callout fadeInLeft">
        ...
        <p>Eastlake athletic clubs are the areas largest local family owned sport and 24 hour facilities.</p>
      ...
      <div class="hero-img pull-right fadeInRight">
        <div class="hero-img-slider">
          <img class="item" src="images/homepage/promo-hero.png" alt="Current Special" data-title="Current special offer!" />
