...
{% block main %}
  ...
  <div class="row">
    <div class="col-md-8">
      <img class="img-thumbnail push-bottom" src="{{ root }}images/gyms/gym-goshen.png" />
      <div class="row push-bottom">
        <div class="col-xs-4">
          <a class="gallery-item" href="{{ root }}images/gyms/goshen/1.jpg"><img class="img-thumbnail" src="{{ root }}images/gyms/goshen/1-thumb.png" /></a>
        </div>
        <div class="col-xs-4">
          <a class="gallery-item" href="{{ root }}images/gyms/goshen/2.jpg"><img class="img-thumbnail" src="{{ root }}images/gyms/goshen/2-thumb.png" /></a>
        </div>
        <div class="col-xs-4">
          <a class="gallery-item" href="{{ root }}images/gyms/goshen/3.jpg"><img class="img-thumbnail" src="{{ root }}images/gyms/goshen/3-thumb.png" /></a>
        </div>
      </div>
